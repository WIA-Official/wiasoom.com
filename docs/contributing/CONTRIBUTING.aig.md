...
Evri kontribushin mek WIA SOOM betta fo dɛvɛlɔpaz aroun di wʌrld.

Wɛða yu fiks a typo, translɛt a string, bild a plugin, ɔr add a major fɛtʃa — **yu a part a dis stɔri.**
