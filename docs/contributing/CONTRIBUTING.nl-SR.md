...
- [Hoe Bugs te Rapporteren](#-how-to-report-bugs)
- [Hoe Functies voor te Stellen](#-how-to-suggest-features)
- [Hoe een Plugin in te Dien](#-how-to-submit-a-plugin)
- [Hoe een Pull Request in te Dien](#-how-to-submit-a-pull-request)
...
5. Commit met een duidelijke boodschap:
   ```
   feat: voeg dark mode toggle toe aan instellingen
   ```
...
- [ ] Geen `console.log` achtergelaten in productiecode
...
- Basistaal bestand: `src/renderer/src/i18n/en.json`
