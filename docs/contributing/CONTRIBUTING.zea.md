...
<p align="center"><strong>We zouden uw bijdragen geweldig vinden!</strong></p>
<p align="center">Of het nu gaat om een bugfix, nieuwe functie, plugin of vertaling — elke bijdrage telt.</p>
...
- [Hoe Bugs te Melden](#-hoe-bugs-te-melden)
- [Hoe Functies Voor te Stellen](#-hoe-functies-voor-te-stellen)
- [Hoe een Plugin in te Dien](#-hoe-een-plugin-in-te-dien)
- [Hoe een Pull Request in te Dien](#-hoe-een-pull-request-in-te-dien)
- [Vertaalbijdragen (254 Talen)](#-vertaalbijdragen-254-talen)
- [Ontwikkelingssetup](#-ontwikkelingssetup)

---

## Gedragscode

We zetten ons in voor een gastvrije en inclusieve ervaring voor iedereen.
...
4. Vermeld:
   ...
   - Verwacht vs. werkelijke gedrag
   - Screenshots of terminaluitvoer indien mogelijk

---

## 💡 Hoe Functies Voor te Stellen
...
4. Beschrijf:
   ...
   - Hoe je je voorstelt dat het werkt
   - Eventuele alternatieven die je hebt overwogen

---

## 🔌 Hoe een Plugin in te Dien
...
Lees de **[Plugin Ontwikkelaarsgids](docs/PLUGIN_DEVELOPER_GUIDE.md)** voor:
...
## 🔀 Hoe een Pull Request in te Dien

### Voor de hoofdapp (wia-soom)

1. Fork de repository
2. Maak een functiebranch: `git checkout -b feat/mijn-functie`
...
| `refactor:` | Code herstructurering (geen gedragsverandering) |
| `i18n:` | Vertaalupdates |
...
Veel van onze 254 talen zijn machinaal vertaald. Beoordelingen door moedertaalsprekers zijn ongelooflijk waardevol!
...
```bash
```
> Opmerking: De standaard 2GB heap is niet genoeg vanwege de 254 taalbestanden + Monaco editor bundel (~38MB renderer).
...
Of je nu een typefout corrigeert, een string vertaalt, een plugin bouwt, of een belangrijke functie toevoegt — **je maakt deel uit van dit verhaal.**
