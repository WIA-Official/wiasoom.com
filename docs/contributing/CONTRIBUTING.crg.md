...
<h1 align="center">Kontribuering a WIA SOOM</h1>
<p align="center"><strong>Nou ch'na vos kontribuering!</strong></p>
...
- [Comment Signaler des Bugs](#-comment-signer-des-bugs)
...
- **Soyez inclusif.** Nous soutenons 254 langues et accueillons des contributeurs de chaque pays sur Terre.
- **Pas de harcèlement.** Tolérance zéro pour la discrimination de toute sorte.
...
2. Cliquez sur **"Nouvelle Problème"**
...
4. Décrivez:
   ...
   - Toutes alternatives que vous avez envisagées

---

## 🔌 Comment Soumettre un Plugin

WIA SOOM a un puissant système de plugins — vous pouvez créer votre propre plugin en 5 minutes.
...
5. Commitez avec un message clair:
   ```
   feat: ajouter un commutateur de mode sombre aux paramètres
   ```
...
Beaucoup de nos 254 langues ont été traduites par machine. Les révisions de locuteurs natifs sont incroyablement précieuses!
...
Nous utilisons des codes ISO 639-1 standard (par exemple, `ko`, `en`, `ja`, `ar`, `hi`) avec des variantes régionales si nécessaire (par exemple, `zh-CN`, `pt-BR`).
...
Chacune des contributions rend WIA SOOM meilleur pour les développeurs à travers le monde.

Que vous corrigiez une faute, traduisiez une chaîne, construisiez un plugin ou ajoutiez une fonctionnalité majeure — **vous faites partie de cette histoire.**
