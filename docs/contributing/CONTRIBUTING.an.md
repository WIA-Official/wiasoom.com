...
3. Elige la plantilla de **"Informe de Error"**
4. Incluye:
...
2. Agrega tu plugin a `plugins/{nombre-de-tu-plugin}/`
...
Cada contribución fa que WIA SOOM siga millor per a desenvolupadors d'otres parts del món.

Se sigues un error, traduscas una cadena, construyes un plugin, o añadas una característica important — **eres parte d'esta historia.**

---

<p align="center"><em>Construït amb ❤️ per SmileStory Inc. i contribuïdors d'arreu del món.</em></p>