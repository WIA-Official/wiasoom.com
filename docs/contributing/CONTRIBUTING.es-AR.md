...
- **Sin acoso.** Tolerancia cero hacia la discriminación de cualquier tipo.
...
```bash
```
> Nota: El heap predeterminado de 2GB no es suficiente debido a los 254 archivos de idioma + el paquete del editor Monaco (~38MB de renderizado).
...
Ya sea que corrijas un error tipográfico, traduzcas una cadena, construyas un plugin o agregues una característica importante — **tú eres parte de esta historia.**
