...
- **Sin acoso.** Tolerancia cero para la discriminación de cualquier tipo.
...
WIA SOOM tiene un potente sistema de plugins: puedes crear tu propio plugin en 5 minutos.
...
WIA SOOM soporta **254 idiomas** — desde amhárico hasta zulú, incluyendo braille y idiomas RTL.
