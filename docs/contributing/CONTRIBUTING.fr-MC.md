...
<p align="center"><strong>Nous serions ravis de vos contributions !</strong></p>
<p align="center">Qu'il s'agisse d'un correctif, d'une nouvelle fonctionnalité, d'un plugin ou d'une traduction — chaque contribution compte.</p>
...
- **Pas de harc��lement.** Tolérance zéro pour toute forme de discrimination.
...
2. Ajoutez votre plugin dans `plugins/{your-plugin-name}/`
...
5. Commitez avec un message clair :
   ```
   feat: ajouter un interrupteur de mode sombre dans les paramètres
   ```
