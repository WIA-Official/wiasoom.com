...
<p align="center"><strong>Avremmo piacer a i tò contributi!</strong></p>
...
- **Niente molestie.** Zero tolleranza per discriminazioni di qualsiasi tipo.
...
2. Crea un branch di funzionalità: `git checkout -b feat/mia-funzionalità`
...
- [ ] Niente stringhe hardcoded (usa chiavi i18n)
- [ ] Niente `console.log` lasciato nel codice di produzione
...
Molte delle nostre 254 lingue sono state tradotte automaticamente. Le revisioni dei madrelingua sono incredibilmente preziose!

1. Scegli il tuo file di lingua
2. Rivedi le traduzioni
3. Correggi eventuali traduzioni imprecise o goffe
4. Invia una PR
...
```bash
```
> Nota: L'heap predefinito di 2GB non è sufficiente a causa dei 254 file di lingua + pacchetto dell'editor Monaco (~38MB di renderer).
...
Ogni cuntribuziòun la fa WIA SOOM méj per i sviluppatòur da töt al mond.

Sia che t'còrregi un errore, t'traduzi un string, t'costruìs un plugin, o t'aggiungi una funzionalità major — **t'se parte di sta storia.**

---

<p align="center"><em>Fatt cun ❤️ da SmileStory Inc. e cuntribuitòur da töt al mond.</em></p>