...
<h1 align="center">Pag-aambag sa WIA SOOM</h1>
<p align="center"><strong>Ikalulugod naming tanggapin ang inyong mga kontribusyon!</strong></p>
...
- [Setup ng Pag-unlad](#-setup-ng-pag-unlad)

---

## Code of Conduct

Kami ay nakatuon sa pagbibigay ng isang magiliw at inklusibong karanasan para sa lahat.

- **Maging magalang.** Igalang ang lahat.
- **Maging nakabubuong.** Magbigay ng nakatutulong na puna, hindi nakasisirang kritisismo.
- **Maging inklusibo.** Sinusuportahan namin ang 254 wika at tinatanggap ang mga kontribyutor mula sa bawat bansa sa mundo.
- **Walang pang-aabuso.** Walang pagtanggap sa diskriminasyon ng anumang uri.
...
Mayroong makapangyarihang sistema ng plugin ang WIA SOOM — maaari kang bumuo ng iyong sariling plugin sa loob ng 5 minuto.
...
- Kumpletong sanggunian ng API
- Mga gumaganang halimbawa
- Mga hakbang-hakbang na tutorial
- Mga pinakamahusay na kasanayan at mga patakaran sa seguridad
...
5. Mag-commit na may malinaw na mensahe:
   ...
   ```
6. I-push at buksan ang isang PR laban sa `main`

### Convention ng Mensahe ng Commit
...
- [ ] Patuloy na pumasa ang mga umiiral na pagsusulit

---

## 🌐 Mga Kontribusyon sa Pagsasalin (254 Wika)

Sinusuportahan ng WIA SOOM ang **254 wika** — mula Amharic hanggang Zulu, kasama ang Braille at mga wika na RTL.

### Paano Gumagana ang Pagsasalin

- Base language file: `src/renderer/src/i18n/en.json`
- Lahat ng 254 language files ay nasa parehong direktoryo
- Ang pagsasalin ay ginagawa sa pamamagitan ng `scripts/translate-patch.js` (GPT-4o-mini API)

### Paano Mag-ambag ng mga Pagsasalin
...
```
#### Opsyon 3: Suriin ang mga machine translations

Marami sa aming 254 na wika ang na-translate ng makina. Napakahalaga ng pagsusuri ng mga katutubong nagsasalita!

1. Pumili ng iyong language file
2. Suriin ang mga pagsasalin
3. Ayusin ang anumang awkward o maling pagsasalin
4. Mag-submit ng PR

### Mga Kodigo ng Wika

Gumagamit kami ng mga pamantayang ISO 639-1 na mga kodigo (hal., `ko`, `en`, `ja`, `ar`, `hi`) na may mga rehiyonal na variant kung kinakailangan (hal., `zh-CN`, `pt-BR`).
...
Kahit na nag-aayos ka ng typo, nagsasalin ng isang string, bumubuo ng isang plugin, o nagdadagdag ng isang malaking tampok — **ikaw ay bahagi ng kwentong ito.**
