...
3. Elige la plantilla de **"Reporte de Errores"**
4. Incluye:
...
1. Ve a [GitHub Issues](https://github.com/WIA-Official/wiasoom.com/issues)
2. Haz clic en **"Nueva Problema"**
3. Elige la plantilla de **"Solicitud de Función"**
4. Describe:
...
- [ ] No hay cadenas codificadas (usa claves i18n)
...
- Todos los archivos de idioma de 254 están en el mismo directorio
...
1. Encuentra el archivo de idioma: `src/renderer/src/i18n/{código-idioma}.json`
...
Muchas de nuestras 254 lenguas fueron traducidas automáticamente. ¡Las revisiones de hablantes nativos son increíblemente valiosas!
...
Ya sea que corrijas un error tipográfico, traduzcas una cadena, construyas un plugin o agregues una función importante — **tú eres parte de esta historia.**

---

<p align="center"><em>Construido con ❤️ por SmileStory Inc. y colaboradores de todo el mundo.</em></p>
```bash
