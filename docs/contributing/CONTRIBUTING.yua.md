...
<h1 align="center">K'a'abéet WIA SOOM</h1>
<p align="center"><strong>Ma' k'a'abéet a k'i'ik'!</strong></p>
<p align="center">Tu'ux k'i'ik' le bug, nuevo característica, plugin, o traducción — k'i'ik' tu yéetel.</p>

---

## Tábula de Contenidos

- [Código de Conducta](#código-de-conducta)
- [Cómo Reportar Bugs](#-cómo-reportar-bugs)
- [Cómo Sugerir Características](#-cómo-sugerir-características)
...
3. Elige la plantilla **"Reporte de Bug"**
4. Incluye:
...
1. Ve a [GitHub Issues](https://github.com/WIA-Official/wiasoom.com/issues)
2. Haz clic en **"Nueva Problema"**
3. Elige la plantilla **"Solicitud de Característica"**
4. Describe:
...
2. Crea una rama de característica: `git checkout -b feat/mi-característica`
...
- [ ] Sin cadenas codificadas (usa claves i18n)
...
WIA SOOM apoya **254 idiomas** — desde Amárico hasta Zulú, incluyendo Braille e idiomas RTL.
