...
<h1 align="center">Kontribusi ka WIA SOOM</h1>
<p align="center"><strong>We'd love your contributions!</strong></p>
<p align="center">Sama ada itu perbaikan bug, fitur baru, plugin, atau terjemahan — setiap kontribusi itu penting.</p>
...
Kami berkomitmen untuk memberikan pengalaman yang ramah dan inklusif untuk semua orang.
...
- **Tanpa pelecehan.** Nol toleransi untuk diskriminasi dalam bentuk apapun.
...
WIA SOOM memiliki sistem plugin yang kuat — Anda bisa membangun plugin Anda sendiri dalam 5 menit.
...
4. Uji secara lokal:
   ```bash
   ```
5. Komit dengan pesan yang jelas:
   ```
...
- [ ] Tidak ada `console.log` yang tersisa di kode produksi
...
#### Opsi 1: Perbaiki terjemahan tertentu

1. Temukan file bahasa: `src/renderer/src/i18n/{lang-code}.json`
2. Perbaiki terjemahan yang salah
3. Kirim PR dengan perubahan
...
```bash
```
> Catatan: Heap default 2GB tidak cukup karena 254 file bahasa + bundel editor Monaco (~38MB renderer).
...
Evri kontribyushin mek WIA SOOM beta fo dɛvɛlɔpɛrs aʊnd di wɜrld.

Wɛðɛr yu fiks a taɪpo, trænslɛt a strɪŋ, bɪld a plʌgɪn, ɔr æd a meɪdʒə fiʧər — **yu a pɑrt ʌv ðɪs stɔri.**
