...
<h1 align="center">Mitwirken an WIA SOOM</h1>
...
2. Klicke auf **"Neues Problem"**
3. Wähle die Vorlage **"Bugbericht"**
4. Füge hinzu:
...
1. Gehe zu [GitHub Issues](https://github.com/WIA-Official/wiasoom.com/issues)
2. Klicke auf **"Neues Problem"**
3. Wähle die Vorlage **"Feature-Anfrage"**
4. Beschreibe:
...
WIA SOOM hat ein leistungsstarkes Plugin-System — du kannst dein eigenes Plugin in 5 Minuten erstellen.
...
- [ ] Keine `console.log` in Produktionscode hinterlassen
...
```bash
```
> Hinweis: Der Standard-2GB-Heap ist aufgrund der 254 Sprachdateien + Monaco-Editor-Bundle (~38MB Renderer) nicht ausreichend.
