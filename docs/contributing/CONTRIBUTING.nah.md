...
2. Haz clic en **"Nueva Issue"**
3. Elige la plantilla **"Reporte de Error"**
4. Incluye:
...
5. Realiza un commit con un mensaje claro:
   ```
   feat: agregar conmutador de modo oscuro a configuraciones
   ```
...
WIA SOOM soporta **254 idiomas** — desde amárico hasta zulú, incluyendo braille e idiomas RTL.
...
Muchos de nuestros 254 idiomas fueron traducidos por máquinas. ¡Las revisiones de hablantes nativos son increíblemente valiosas!
...
```bash
```
> Nota: El montón por defecto de 2GB no es suficiente debido a los 254 archivos de idioma + paquete del editor Monaco (~38MB renderizador).
