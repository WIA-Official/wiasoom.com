...
4. Sisällytä:
   ...
   - Toimenpiteet toistaa
   - Odotettu vs. todellinen käyttäytyminen
   - Näyttökuvat tai terminaalilähtö, jos mahdollista
...
4. Tarkastuksen jälkeen liitännäisesi ilmestyy Plugin Storeen kaikille käyttäjille!
...
- Käännös tehdään `scripts/translate-patch.js` (GPT-4o-mini API) avulla
...
### Rakentaminen
§§§CHUNK_SEPARATOR§§§
> Huom: Oletusarvoinen 2GB:n muistiraja ei riitä 254 kielitiedoston + Monaco-editorin paketin (~38MB renderöinti) vuoksi.
...
Olgu see trükivea parandamine, stringi tõlkimine, plugina loomine või suure funktsiooni lisamine — **sa oled osa sellest loost.**

---

<p align="center"><em>Valmistatud ❤️ poolt SmileStory Inc. ja panustajate poolt üle kogu maailma.</em></p>
```bash
