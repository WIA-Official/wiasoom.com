...
Evri kontribushin mek WIA SOOM beta fo developers aroun di world.

Weda yu fix a typo, translate a string, build a plugin, or add a major feature — **yu a part of dis story.**
