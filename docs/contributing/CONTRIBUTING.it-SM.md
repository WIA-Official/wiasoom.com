...
- **Sii inclusivo.** Supportiamo 254 lingue e accogliamo collaboratori da ogni paese del mondo.
...
3. Scegli il modello **"Bug Report"**
4. Includi:
...
1. Vai su [GitHub Issues](https://github.com/WIA-Official/wiasoom.com/issues)
2. Clicca su **"New Issue"**
3. Scegli il modello **"Feature Request"**
4. Descrivi:
...
Utilizziamo i codici standard ISO 639-1 (ad es., `ko`, `en`, `ja`, `ar`, `hi`) con varianti regionali dove necessario (ad es., `zh-CN`, `pt-BR`).
...
Che tu stia correggendo un refuso, traducendo una stringa, costruendo un plugin o aggiungendo una funzionalità importante — **fai parte di questa storia.**
