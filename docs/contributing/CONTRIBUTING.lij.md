...
<p align="center"><strong>Ci piacerà i vostri contributi!</strong></p>
<p align="center">Che sia una correzione di bug, una nuova funzionalità, un plugin, o una traduzione — ogni contributo conta.</p>
...
- [ ] Niente `console.log` lasciati nel codice di produzione
...
3. Correggi eventuali traduzioni goffe o errate
4. Invia una PR
...
Che tu stia correggendo un errore di battitura, traducendo una stringa, costruendo un plugin, o aggiungendo una funzione importante — **tu fai parte di questa storia.**
