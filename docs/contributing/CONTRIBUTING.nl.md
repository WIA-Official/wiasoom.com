...
- [Vertalingsbijdragen (254 Talen)](#-vertalingsbijdragen-254-talen)
...
1. Ga naar [GitHub Issues](https://github.com/WIA-Official/wiasoom.com/issues)
2. Klik op **"New Issue"**
3. Kies de **"Feature Request"** sjabloon
4. Beschrijf:
...
- Beste praktijken en beveiligingsregels
...
5. Commit met een duidelijke boodschap:
   ```
   feat: voeg donkere modus toe aan instellingen
   ```
