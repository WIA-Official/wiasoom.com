...
<p align="center">Sama ada ia pembetulan bug, ciri baru, plugin, atau terjemahan — setiap sumbangan adalah penting.</p>
...
Kami komited untuk menyediakan pengalaman yang mesra dan inklusif untuk semua.

- **Hormat.** Layan semua orang dengan maruah.
- **Konstruktif.** Berikan maklum balas yang berguna, bukan kritikan yang merosakkan.
...
5. Komit dengan mesej yang jelas:
   ```
   feat: tambah togol mod gelap kepada tetapan
   ```
6. Push dan buka PR terhadap `main`

### Konvensyen Mesej Komit

| Prefiks | Digunakan untuk |
|--------|---------|
| `feat:` | Ciri baru |
| `fix:` | Pembetulan bug |
...
Banyak daripada 254 bahasa kami telah diterjemahkan oleh mesin. Semakan oleh penutur asli sangat berharga!
...
Kami menggunakan kod standard ISO 639-1 (contohnya, `ko`, `en`, `ja`, `ar`, `hi`) dengan variasi serantau di mana perlu (contohnya, `zh-CN`, `pt-BR`).
...
### Pembinaan
§§§CHUNK_SEPARATOR§��§
> Nota: Heap 2GB lalai tidak mencukupi kerana 254 fail bahasa + bundel editor Monaco (~38MB renderer).
...
Setiap sumbangan menjadikan WIA SOOM lebih baik untuk para pembangun di seluruh dunia.

Sama ada anda membetulkan kesilapan, menterjemah satu rentetan, membina satu plugin, atau menambah ciri utama — **anda adalah sebahagian daripada kisah ini.**
