...
<h1 align="center">貢獻 WIA SOOM</h1>
<p align="center"><strong>我們非常歡迎你的貢獻！</strong></p>
<p align="center">無論是修正錯誤、新功能、插件或翻譯 — 每一份貢獻都很重要。</p>
...
```bash
```
> 注意：由於 254 種語言文件 + Monaco 編輯器包 (~38MB 渲染器)，默認的 2GB 堆積空間不足。
...
每一個貢獻都讓 WIA SOOM 對全球的開發者變得更好。

無論你是修正一個錯字、翻譯一個字串、建立一個插件，還是新增一個主要功能 — **你都是這個故事的一部分。**
