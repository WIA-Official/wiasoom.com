...
Nous nous engageons à fournir une expérience accueillante et inclusive pour tout le monde.
...
- **Soyez inclusif.** Nous supportons 254 langues et accueillons des contributeurs de chaque pays de la Terre.
...
5. Commitez avec un message clair :
   ```
   feat: ajouter un commutateur de mode sombre dans les paramètres
   ```
...
WIA SOOM supporte **254 langues** — de l'amharique au zoulou, y compris le braille et les langues RTL.
