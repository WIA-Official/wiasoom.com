...
<p align="center">Bilo da je reč o ispravci greške, novoj funkciji, pluginu ili prevodu — svaki doprinos je važan.</p>
...
- [Podešavanje razvoja](#-development-setup)
...
- **Budite poštovanja.** Ponašajte se prema svima s dostojanstvom.
...
WIA SOOM ima moćan sistem pluginova — možete izgraditi svoj plugin za 5 minuta.
...
Pročitajte **[Plugin Developer Guide](docs/PLUGIN_DEVELOPER_GUIDE.md)** za:
...
4. Testirajte lokalno:
   ```bash
   ```
5. Komitujte sa jasnom porukom:
   ```
   feat: dodaj preklopnik za tamni režim u podešavanjima
   ```
6. Povežite i otvorite PR protiv `main`

### Konvencija za poruke komita
...
| `plugin:` | Izmene vezane za plugin |
...
Bilo da ispravite grešku, prevedete string, izgradite plugin ili dodate veliku funkciju — **vi ste deo ove priče.**

---

<p align="center"><em>Izgrađeno sa ❤️ od strane SmileStory Inc. i saradnika širom sveta.</em></p>