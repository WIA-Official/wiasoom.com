...
<h1 align="center">Guía para Desarrolladores de Plugins de WIA SOOM</h1>
<p align="center"><strong>Crea tu propio plugin en 5 minutos.</strong></p>
<p align="center">Crea herramientas de servidor potentes, paneles de control y automatizaciones — directamente dentro de WIA SOOM.</p>
...
Un plugin "Hola Mundo" que agrega un botón a la barra lateral. Al hacer clic, muestra una notificación.
...
§§§CHUNK_SEPARATOR§§§
**Importante:** Siempre guarda la función de cancelación de suscripción y llámala en `deactivate()` para evitar fugas de memoria.
...
Agrega un botón a la barra lateral de WIA SOOM.
...
```
> Ver [Parte 3](#part-3-building-custom-ui-with-webviews) para patrones avanzados de webview.
...
La API `openWebview()` te permite construir UIs de panel con HTML, CSS y JavaScript — todo dentro de una ventana emergente.
...
| **NUNCA** obtengas URLs externas | Excepción: endpoints de la API de `wiasoom.com` |
...
Un plugin que gestiona una lista de TODO utilizando configuraciones para almacenamiento persistente y un webview para visualización.
...
| `business` | Herramientas empresariales |
...
<p align="center"><em>Crea algo increíble. Compártelo con el mundo.</em></p>
