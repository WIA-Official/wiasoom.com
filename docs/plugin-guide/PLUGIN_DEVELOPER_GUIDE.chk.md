...
<p align="center"><strong>Fang a plugin en 5 minutes.</strong></p>
<p align="center">Mweko a powerful server tools, dashboards, mo automations — pwe pwe WIA SOOM.</p>
...
|----------|-------------|
| `server` | Wia server management |
| `devtools` | Wia development tools |
| `calculator` | Wia calculators and converters |
| `simulator` | Wia simulators |
| `game` | Wia terminal games |
| `business` | Wia business tools |
| `security` | Wia security and auditing |
| `web` | Wia web server management |
| `education` | Wia educational tools |
| `health` | Wia health-related tools |
| `islamic` | Wia Islamic tools (prayer times, etc.) |
| `science` | Wia scientific tools |
| `quantum` | Wia quantum computing tools |
| `ai` | Wia AI-powered tools |
| `biotech` | Wia biotechnology tools |
| `space` | Wia space and astronomy tools |
| `network` | Wia network tools |
| `database` | Wia database management |
| `monitoring` | Wia server monitoring |
| `devops` | Wia DevOps and CI/CD |
| `utility` | Wia general utilities |
| `design` | Wia design tools |
| `ecommerce` | Wia e-commerce tools |
| `automation` | Wia automation tools |
| `kpop` | Wia K-pop related tools |
| `accessibility` | Wia accessibility tools |
| `analytics` | Wia analytics and reporting |
| `wia` | WIA ecosystem tools |
| `all` | Wia appears in all categories |
...
| `server` | Wia server management |
| `shield` | Wia security |
| `database` | Wia database |
| `activity` | Wia monitoring |
| `terminal` | Wia terminal tools |
| `code` | Wia development |
| `hard-drive` | Wia disk/storage |
| `network` | Wia networking |
| `lock` | Wia auth/encryption |
| `eye` | Wia watching/monitoring |
| `check-square` | Wia tasks/TODO |
| `layout-dashboard` | Wia dashboards |
| `settings` | Wia configuration |
| `zap` | Wia automation |
| `globe` | Wia web/international |
