...
<p align="center"><strong>Wia a pishkushit plugin 5 minut.</strong></p>
<p align="center">Kreati uin pawaful server tools, dashboards, ak automations — uin WIA SOOM.</p>
...
Uin "Hello World" plugin ka addi uin button uin sidebar. Kishi click, uin showi uin notification.
...
Restart uin app (or toggle uin plugin off/on uin Settings → Plugins).

Uin **"Hello World"** button uin sidebar. Clicki — uin see uin success notification!
...
Kishi uin `activate(context)` function ka calli, `context` (or `ctx`) ka providei uin APIs:
```typescript
...
Sendi uin command (or any data) uin active terminal session.

| Parameter | Type | Description |
|-----------|------|-------------|
| `sessionId` | `string` | Uin terminal session ka sendi |
| `data` | `string` | Uin command or data ka sendi |
```javascript
...
Subscribei uin all output from uin terminal session. Returns uin **unsubscribe function**.

| Parameter | Type | Description |
|-----------|------|-------------|
| `sessionId` | `string` | Uin terminal session ka watchi |
| `callback` | `(data: string) => void` | Calli uin each chunk of output |
| **Returns** | `() => void` | Calli uin stopi listening |
```javascript
...
unsubscribe();
```
**Important:** Always savei uin unsubscribe function ak calli uin `deactivate()` uin preventi memory leaks.

---

### `ctx.sftp` — File transfer

> **Status: Coming Soon** — Uin SFTP API ka defined but not yet wired uin uin app's SFTP engine. `list()` currently returns uin empty array, ak `upload()`/`download()` are no-ops. This will be fully implemented uin uin future release. For now, use `ctx.terminal.send()` uin `scp` or `rsync` commands uin a workaround.

#### `sftp.list(sessionId, path)`

Listi files uin uin remote directory.
```javascript
...
Uploadi uin file from local machine uin remote server.
```javascript
...
Downloadi uin file from remote server uin local machine.
```javascript
...
Addi uin button uin WIA SOOM sidebar.

| Option | Type | Required | Description |
|--------|------|----------|-------------|
| `id` | `string` | No | Unique ID (defaults uin plugin name) |
| `icon` | `string` | Yes | Lucide icon name (e.g., `'server'`, `'shield'`, `'database'`) |
| `label` | `string` | Yes | Button text shown uin sidebar |
| `onClick` | `() => void` | Yes | Function calli kishi button ka clicki |
```javascript
context.ui.addSidebarButton({
  id: 'my-dashboard',
...
```
**Icon reference:** Browsei all available icons uin [lucide.dev/icons](https://lucide.dev/icons)

> **Compatibility note:** Some older plugins use positional arguments like `addSidebarButton(id, icon, label, onClick)`. Uin official API uses uin **options object** as documented above. Always use uin object style for new plugins.

#### `ui.openWebview(options)`

Openi uin popup window with custom HTML content. This is how you buildi rich UIs.

| Option | Type | Description |
|--------|------|-------------|
| `title` | `string` | Window title |
| `html` | `string` | Full HTML content ka renderi |
```javascript
context.ui.openWebview({
  title: 'Server Status',
  html: `
...
|----------|-------------|
| `server` | Maanit uapshkueu server |
| `devtools` | Uapshkueu uapshkueu |
| `calculator` | Uapshkueu uapshkueu uapshkueu |
| `simulator` | Uapshkueu simulatshun |
| `game` | Uapshkueu uapshkueu uapshkueu |
| `business` | Uapshkueu uapshkueu |
| `security` | Uapshkueu uapshkueu |
| `web` | Maanit uapshkueu web |
| `education` | Uapshkueu uapshkueu |
| `health` | Uapshkueu uapshkueu uapshkueu |
| `islamic` | Uapshkueu islamique (uapshkueu uapshkueu, etc.) |
| `science` | Uapshkueu uapshkueu |
| `quantum` | Uapshkueu uapshkueu quantique |
| `ai` | Uapshkueu uapshkueu AI |
| `biotech` | Uapshkueu biotechnologie |
| `space` | Uapshkueu uapshkueu uapshkueu |
| `network` | Uapshkueu uapshkueu |
| `database` | Maanit uapshkueu uapshkueu |
| `monitoring` | Uapshkueu uapshkueu |
| `devops` | Uapshkueu DevOps et CI/CD |
| `utility` | Uapshkueu uapshkueu |
| `design` | Uapshkueu uapshkueu |
| `ecommerce` | Uapshkueu e-commerce |
| `automation` | Uapshkueu uapshkueu |
| `kpop` | Uapshkueu K-pop |
| `accessibility` | Uapshkueu uapshkueu |
| `analytics` | Uapshkueu uapshkueu |
| `wia` | Uapshkueu WIA |
| `all` | Appear uapshkueu uapshkueu |

### Recommended Icons (Lucide)

| Icon Name | Use for |
|-----------|---------|
| `server` | Maanit uapshkueu |
| `shield` | Uapshkueu |
| `database` | Uapshkueu |
| `activity` | Uapshkueu |
| `terminal` | Uapshkueu uapshkueu |
| `code` | Uapshkueu |
| `hard-drive` | Uapshkueu uapshkueu |
| `network` | Uapshkueu |
| `lock` | Uapshkueu uapshkueu |
| `eye` | Uapshkueu/uapshkueu |
| `check-square` | Uapshkueu/TODO |
| `layout-dashboard` | Uapshkueu |
| `settings` | Uapshkueu |
| `zap` | Uapshkueu |
| `globe` | Uapshkueu/uapshkueu |
