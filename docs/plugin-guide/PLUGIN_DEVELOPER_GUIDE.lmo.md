...
> **Stato: In Arrivo** — L'API AI è definita ma non ancora connessa a Soomy. Attualmente restituisce `{ response: 'AI not yet connected' }`. L'integrazione completa dell'AI è prevista per un rilascio futuro.
