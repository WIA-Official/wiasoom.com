...
<p align="center"><strong>Fang a plugin in 5 minutes.</strong></p>
<p align="center">Fang a powerful server tools, dashboards, mo automations — ian WIA SOOM.</p>
...
Pweik a persistent text item to the bottom status bar.
...
|----------|-------------|
| `server` | Penehngen server |
| `devtools` | Penehngen a kiso |
| `calculator` | Kalisan en konverter |
| `simulator` | Simulater |
| `game` | Penehngen terminal |
| `business` | Penehngen a business |
| `security` | Penehngen a seguridad en auditing |
| `web` | Penehngen web server |
| `education` | Penehngen a edukasyon |
| `health` | Penehngen a salun |
| `islamic` | Penehngen a islamic (penehngen tiempo a pray, etc.) |
| `science` | Penehngen a science |
| `quantum` | Penehngen a quantum computing |
| `ai` | Penehngen a AI-powered |
| `biotech` | Penehngen a biotechnology |
| `space` | Penehngen a space en astronomy |
| `network` | Penehngen a network |
| `database` | Penehngen a database |
| `monitoring` | Penehngen a server monitoring |
| `devops` | Penehngen a DevOps en CI/CD |
| `utility` | Penehngen a utilities |
| `design` | Penehngen a design |
| `ecommerce` | Penehngen a e-commerce |
| `automation` | Penehngen a automation |
| `kpop` | Penehngen a K-pop |
| `accessibility` | Penehngen a accessibility |
| `analytics` | Penehngen a analytics en reporting |
| `wia` | Penehngen a WIA ecosystem |
| `all` | Penehngen a all categories |
...
| `database` | Database |
| `activity` | Monitoring |
| `terminal` | Penehngen terminal |
| `code` | Penehngen a kiso |
| `hard-drive` | Disk/storage |
| `network` | Networking |
| `lock` | Auth/encryption |
| `eye` | Penehngen watching/monitoring |
| `check-square` | Penehngen tasks/TODO |
| `layout-dashboard` | Penehngen dashboards |
| `settings` | Penehngen configuration |
| `zap` | Penehngen automation |
| `globe` | Penehngen web/international |
