...
Un plugin de "Hola Mundo" que añade un botón a la barra lateral. Al hacer clic, muestra una notificación.
...
La API `openWebview()` te permite construir interfaces de usuario de panel con HTML, CSS y JavaScript — todo dentro de una ventana emergente.
...
| **NUNCA** obtener URLs externas | Excepción: puntos finales de la API de `wiasoom.com` |
...
| **DEBE** limpiar en `deactivate()` | Remover listeners, limpiar intervalos |
