...
- [Parte 1: Avvio Rapido — Il Tuo Primo Plugin in 5 Minuti](#parte-1-avvio-rapido--il-tuo-primo-plugin-in-5-minuti)
...
## Parte 1: Avvio Rapido — Il Tuo Primo Plugin in 5 Minuti
...
Apri una finestra popup con contenuto HTML personalizzato. Questo è come costruisci UIs ricche.
...
```
> Vedi [Parte 3](#part-3-building-custom-ui-with-webviews) për schemi avanzate di webview.
...
> **Stato: In Arrivo** — L'API AI è definita ma non ancora connessa a Soomy. Attualmente restituisce `{ response: 'AI not yet connected' }`. È prevista un'integrazione completa dell'AI per una futura versione.
