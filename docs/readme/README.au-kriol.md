...
2 to 4 AIs solve the same problem at the same time — not just chatting, but actually editing code on your server. Each AI works in its own isolated Git branch. Compare their results side by side. Pick the winner. The rest get cleaned up.
