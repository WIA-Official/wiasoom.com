...
Ika an app. Fene. Open Source. 254 Languages.
</p>
...
<p align="center"><em>SUI (Soom User Interface) — Pweko an, AI pweko.</em></p>
...
Ika feature emen pweko an i ka terminal client — an pweko.
